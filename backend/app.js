...
app.post('/api/seed-data', async (req, res) => {
    try {
        // Dữ liệu mẫu cho Nha Trang
        const sampleDestinations = [
            {
                name: 'Bún chả cá Nha Trang',
                description: 'Món bún chả cá truyền thống nổi tiếng của Nha Trang',
                address: '12 Nguyễn Thị Minh Khai',
                city: 'Nha Trang',
                latitude: 12.2388,
                longitude: 109.1967,
                category: 'am-thuc',
                image_url: 'https://example.com/bun-cha-ca.jpg'
            },
            {
                name: 'Vinpearl Land',
                description: 'Khu vui chơi giải trí hàng đầu Nha Trang',
                address: 'Đảo Hòn Tre',
                city: 'Nha Trang',
                latitude: 12.1833,
                longitude: 109.2333,
            ...
            {
                name: 'Khách sạn Sheraton Nha Trang',
                ...
                longitude: 109.1967,
                category: 'khach-san',
                image_url: 'https://example.com/sheraton.jpg'
            },
            {
                ...
                longitude: 109.1956,
                category: 'tham-quan',
                image_url: 'https://example.com/thap-ba.jpg'
            },
            {
                name: 'Nhà hàng Lanterns',
                description: 'Nhà hàng hải sản cao cấp',
                address: '34/6 Nguyễn Thiện Thuật',
                city: 'Nha Trang',
                latitude: 12.2388,
                longitude: 109.1967,
                category: 'am-thuc',
                image_url: 'https://example.com/lanterns.jpg'
            },
            {
        ...
        const createdDestinations = await Destination.bulkCreate(sampleDestinations);
        ...
        res.status(500).json({ 
            error: 'Đã có lỗi xảy ra khi thêm dữ liệu mẫu',
            details: error.message 
        });
    }
});
